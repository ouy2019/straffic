  ...
  <div class="shixiang" v-show="index == 0">
    ...
    <div class="direct" v-if="!dataObject.meetings.length==''">
      ...
      <div class="detail">
        ...
        <div v-for="(meetings,index) in dataObject.meetings" :key="index">
          <div v-if="index >= 1" class="spaceKey"></div>
          <van-cell-group :border="false">
            <van-cell :border="false" title="会议名称" :value="meetings.name" size="small" class="text_l" />
            <van-cell :border="false" title="会议日期" :value="meetings.beginDate" size="small" class="text_l" />
            <van-cell :border="false" title="结束日期" :value="meetings.endDate" size="small" class="text_l" />
            <van-cell :border="false" title="会议地点" :value="meetings.place" size="small" class="text_l" />
          </van-cell-group>
          <!-- 支出详情 -->
          <div class="details disbursement">
              <van-collapse v-model="AcTab">
                <van-collapse-item title="支出详情" name="1">
                  <el-table :data="meetings.details" style="width: 100%" >
...
export default {
    ...
    data() {
        return {
            ...
            huiyiIcon: require("../../../assets/img/huiyiIcon.png"),
