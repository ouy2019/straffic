     ...
     <div class="shixiang" v-show="index == 0">
      <div class="detail">
        ...
        <van-cell-group :border="false">
          ...
          <van-cell :border="false"
            title="关联合同编号"
            :value="dataObject.contract.contractNo"
            size="small"
            class="text_l"
          />
        </van-cell-group>
       ...
       <div class="detail">
         <div class="title"><img :src="hetong" alt="" srcset="" class="sxIcon" />{{title}} </div>
            <div class="details disbursement">
                ...
                <div class="total">申请金额合计(元) : {{dataObject.contract.total.toFixed(2)}} </div>
            </div>
       </div>
      </div>
        ...
        <div class="margin"> 
            ...
            <div v-for="(item,index) in dataObject.indices" :key="index"> 
              <van-cell-group :border="false">
                <van-cell :border="false"
                  title="项目名称"
                  :value="item.contractIndex.index.projectName"
                  size="small"
                  class="text_l"
                />
                <van-cell :border="false"
                  title="指标余额"
                  :value="item.contractIndex.index.allocationAmount.toFixed(2)"
                  size="small"
                  class="text_l"
                />
                <van-cell :border="false"
                  title="申请金额"
                  :value="item.contractIndex.amount.toFixed(2)"
                  size="small"
                  class="text_l"
                />
                <van-cell :border="false"
                  title="支出明细"
                  :value="item.contractIndex.index.largeProjectName"
                  size="small"
                  class="text_l"
                />
                </van-cell-group>
