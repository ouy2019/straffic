      ...
      <div class="detail">
        ...
        <van-cell-group :border="false">
          ...
          />
           <van-cell :border="false"
            title="本次报销(元)"
            :value="dataObject.paymentReport.meetingContractsTotal | num"
            size="small"
            class="text_l" 
          />
           <van-cell :border="false"
      ...
      <div class="direct" v-if="!dataObject.abroad.length==''">
       ...
       <div class="detail">
         ...
         <div v-for="(item,index) in dataObject.abroad" :key="index">
            ...
            <van-cell :border="false"
              title="国家"
              :value="item.country.area"
              size="small"
              class="text_l"
            />
            <van-cell :border="false"
              title="出访地区"
              :value="item.regional.area"
              size="small"
              class="text_l"
            />
            <van-cell :border="false"
        ...
        <div class="margin">
            ...
            <!-- <div v-for="(item,index) in dataObject.indices" :key="index"> 
              <van-cell-group :border="false">
                ...
                <van-cell :border="false"
                  title="指标余额"
                  :value="item.reportIndex.index.allocationAmount | num"
                  size="small"
                  class="text_l"
                />
                <van-cell :border="false"
                  title="申请金额"
                  :value="item.applyAmount | num"
                  size="small"
                  class="text_l"
                />
                </van-cell-group>
