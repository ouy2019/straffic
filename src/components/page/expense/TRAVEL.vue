  ...
  <div class="shixiang" v-show="index == 0">
        ...
        <div class="detail">
          ...
          <van-cell-group :border="false">
            ...
            <div v-if="state">
            <van-cell :border="false" title="支出事由" value="差旅费-负数问题" size="small" class="text_l" />
            </div>
          ...
          <div class="detail">
            ...
            <div v-for="(item,index) in dataObject.travelExpenses" :key="index">
              <div v-if="index >= 1" class="spaceKey"></div>
                ...
                <van-cell :border="false" title="申请金额" :value="item.details.amount | num" size="small" class="text_l" />
                </div>
                </van-cell-group>
                <!-- 支出详情 -->
