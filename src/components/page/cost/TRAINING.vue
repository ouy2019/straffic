  ...
  <div class="shixiang" v-show="index == 0">
    ...
    <div class="detail">
      ...
      <van-cell-group :border="false">
        ...
        <van-cell :border="false" title="申请金额" :value="dataObject.total | num" size="small"  class="text_l"  />
      </van-cell-group>
    </div>
    <!--培训费-->
      ...
      <div class="detail">
        ...
        <div class="" v-for="(item,index) in dataObject.trainings" :key="index">
          ...
          <van-cell-group :border="false">
            ...
            <van-cell :border="false" title="税后申请总金额(元)" :value="dataObject.total | num" size="small" class="text_l" />
          </van-cell-group>
