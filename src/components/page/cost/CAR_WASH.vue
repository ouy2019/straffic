     ...
     <div class="shixiang" v-show="index == 0">
      ...
      <div class="detail">
        ...
        <van-cell-group :border="false">
          ...
          <van-cell :border="false" title="车辆驾驶员" :value="dataObject.driver" size="small" class="text_l" />
          <van-cell :border="false" title="申请名称" :value="dataObject.title" size="small" class="text_l" />
